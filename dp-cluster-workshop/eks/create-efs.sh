...
aws ec2 create-tags --resources ${MOUNT_TARGET_GROUP_ID} --tags Key=Cluster,Value=${CLUSTER_NAME}
...
aws efs create-tags --file-system-id ${FILE_SYSTEM_ID} --tags Key=Cluster,Value=${CLUSTER_NAME}
