...
{{- define "o11y-service.jaeger-collector-endpoint-master" }}jaeger-collector.{{ .Values.global.cp.resources.serviceaccount.namespace }}.svc.cluster.local:{{ .Values.global.cp.resources.o11y.config.jaeger.collector.port }}{{ end -}}
