...
{{- define "o11y-service.jaeger-collector-endpoint" }}jaeger-collector.{{ .Values.global.cp.resources.serviceaccount.nameSpace }}.svc.cluster.local:{{ .Values.global.cp.resources.o11y.jaeger.collector.port }}{{ end -}}
